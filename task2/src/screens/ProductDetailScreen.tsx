...
const styles = StyleSheet.create({
    ...
    categoryText: { color: '#0066cc', fontSize: 12, fontWeight: '600' },
    name: { fontSize: 28, fontWeight: 'bold', color: '#333', marginBottom: 8 },
    price: { fontSize: 24, fontWeight: 'bold', color: '#333', marginBottom: 16 },
    ...
    platformVersion: { fontSize: 12, color: '#999', marginTop: 4 },
    addButton: {
